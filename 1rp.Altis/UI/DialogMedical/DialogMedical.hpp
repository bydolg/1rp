...
class DialogMedical {
    ...
    class ControlsBackground {
		...
		class BackgroundBody: Life_RscPicture {
			...
			text = "\dataM\ui\medical\body.paa";
	...
	class Controls {
		...
		class Head: Life_RscActiveText {
			idc = 4901;
			style = ST_PICTURE + ST_CENTER;
			text = "\dataM\ui\medical\head.paa";
		...
		class RArm: Life_RscActiveText {
			idc = 4902;
			style = ST_PICTURE;
			text = "\dataM\ui\medical\rarm.paa";
		...
		class LArm: Life_RscActiveText {
			idc = 4903;
			style = ST_PICTURE;
			text = "\dataM\ui\medical\larm.paa";
		...
		class Body: Life_RscActiveText {
			idc = 4904;
			style = ST_PICTURE + ST_CENTER;
			text = "\dataM\ui\medical\torso.paa";
		...
		class RLegs: Life_RscActiveText {
			idc = 4905;
			style = ST_PICTURE;
			text = "\dataM\ui\medical\rleg.paa";
		...
		class LLegs: Life_RscActiveText {
			idc = 4906;
			style = ST_PICTURE;
			text = "\dataM\ui\medical\lleg.paa";
