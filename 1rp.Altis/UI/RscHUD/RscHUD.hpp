...
class RscHUD {
    ...
    class Controls {
        ...
        class FoodText: Life_RscStructuredText {
            idc = 501;
            text = "<t><img image='\dataM\UI\food.paa' size='0.8'/></t><t align='right'>100%</t>";
            SAFEZONE_X((1 - WIDTH) - MARGIN_X);
			SAFEZONE_Y(((1 - (BUTTON_H * 3)) - MARGIN_Y) - MARGIN_Y);
            SAFEZONE_W(WIDTH);
			SAFEZONE_H(BUTTON_H);
        ...
        class WaterText: Life_RscStructuredText {
            idc = 503;
            text = "<t><img image='\dataM\UI\water.paa' size='0.8'/></t><t align='right'>100%</t>";
            SAFEZONE_X((1 - WIDTH) - MARGIN_X);
			SAFEZONE_Y(((1 - (BUTTON_H * 2)) - MARGIN_Y) - (MARGIN_Y / 2));
             SAFEZONE_W(WIDTH);
			SAFEZONE_H(BUTTON_H);
        ...
        class HealthText: Life_RscStructuredText {
            idc = 505;
            text = "<t><img image='\dataM\UI\health.paa' size='0.8'/></t><t align='right'>100%</t>";
            SAFEZONE_X((1 - WIDTH) - MARGIN_X);
			SAFEZONE_Y(((1 - BUTTON_H) - MARGIN_Y));
            SAFEZONE_W(WIDTH);
			SAFEZONE_H(BUTTON_H);
