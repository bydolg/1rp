class CfgSettings {
    ...
    class CfgCredits {
        ...
        class Hello {
            items[] = {"""Добро пожаловать в""", """OneRP RPG проект!"""};
            condition = "true";
        };
        class Forums : Hello {
    ...
    allowedCharacters = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789 ЙЦУКЕНГШЩЗХЪФЫВАПРОЛДЖЭ/ЯЧСМИТЬБЮЁёйцукенгшщзхъфывапролджэячсмитьбю";
