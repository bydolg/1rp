...
(_display displayCtrl 23001) ctrlSetStructuredText parseText format["<t align='left'>Группа - Прогресс</t>", ((group player) getVariable ["group_type", "Группа"])];
...
(_display displayCtrl 23084) ctrlSetStructuredText parseText format ["<t size='2.5'>Уровень %1<t align='center'>%2/%3</t><t align='right'>Уровень %4</t>",
...

{
	...
	_overlay ctrlSetStructuredText parseText format["<br/><br/><t size='2' align='center'>Требуется Уровень %1</t>", getNumber (_x >> "level")];
