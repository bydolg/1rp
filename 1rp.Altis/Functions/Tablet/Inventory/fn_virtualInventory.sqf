...
(_display displayCtrl 23001) ctrlSetStructuredText parseText format["<t align='left'>Инвентарь</t><t align='right'>%1/%2</t>", _carryWeight, _maxWeight];
