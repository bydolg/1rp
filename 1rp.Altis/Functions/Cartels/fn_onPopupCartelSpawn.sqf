...
"[""PopupCartel"", ""create"", true, thisTrigger getVariable ""popup_cartel""] call ULP_fnc_cartelHud",
"(thisTrigger getVariable ""popup_cartel"") setVariable [""pauseTime"", nil]; [""PopupCartel"", ""remove""] call ULP_fnc_cartelHud"
];
