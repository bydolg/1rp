...
** Описание: Отправляет целевую единицу в тюрьму...
*/
...
if !(isNull _arrester) then {
	[format["Вас приговорили к <t color='#B92DE0'>%1</t> игрой <t color='#B92DE0'>%2</t>", [_duration, "MM:SS"] call BIS_fnc_secondsToString, name _arrester]] call ULP_fnc_hint;
};
