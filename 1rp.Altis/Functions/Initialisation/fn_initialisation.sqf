...
["Начало инициализации"] call ULP_fnc_logIt;

[] call ULP_fnc_initVars;

player allowDammage false;

["Настройка обработчиков событий"] call ULP_fnc_logIt;
...
["Ожидание сервера"] call ULP_fnc_logIt;
...
["Проверка включения в белый список"] call ULP_fnc_logIt;
...
["Установка текстур"] call ULP_fnc_logIt;
...
["Создание мира"] call ULP_fnc_logIt;
...
["Инициализация игрока"] call ULP_fnc_logIt;
...
["Завершение инициализации"] call ULP_fnc_logIt;
...
if (isNil "ULP_UCLevels") then {
	...
	[
		...
		"Играете за гражданских или полицейских под прикрытием?", [_cop, _uc],
		{	
...
[format["Инициализация заняла %1 секунд", diag_tickTime - _startTime]] call ULP_fnc_logIt;
