...
class U_O_R_Gorka_01_black_F {
	...
	class Textures {
		...
		class Hato {
			...
			textures[] = { "\dataM\Textures\Uniforms\Hato\tracksuit.paa" };
...
class U_B_Wetsuit {
	...
	class Textures {
		...
		class MPU {
			displayName = "MPU";
			textures[] = { "\dataM\Textures\Uniforms\Police\Units\MPU.paa" };
...
class U_C_IDAP_Man_Tee_F : U_C_IDAP_Man_shorts_F{
	class Textures {
		class HMP {
			displayName = "HMP";
			textures[] = { "\dataM\Textures\Uniforms\Global\hmp_uniform.paa" };
			condition = "true";
		};
	};
};
...
class U_Competitor {
	...
	class Textures {
		class DR {
			...
			textures[] = { "\dataM\Textures\Uniforms\Medic\main_03.paa" };
			condition = "[player, [""Medic""]] call ULP_fnc_isFaction && { [""Medic_Main"", 5] call ULP_fnc_hasAccess }";
		};
		class PAR {
			displayName = "Doctor";
			textures[] = { "\dataM\Textures\Uniforms\Medic\main_02.paa" };
			condition = "[player, [""Medic""]] call ULP_fnc_isFaction && { [""Medic_Main"", 4] call ULP_fnc_hasAccess }";
		};
		class STU {
			displayName = "Student";
			textures[] = { "\dataM\Textures\Uniforms\Medic\main_01.paa" };
...
class U_B_GEN_Commander_F {
	...
	class Textures {
		class College {
			...
			textures[] = { "\dataM\Textures\Uniforms\Police\Units\COL.paa" };
...
class U_BG_Guerrilla_6_1 : U_B_GEN_Commander_F {
	...
	class Textures {
		class NCA {
			displayName = "NCA";
			textures[] = { "\dataM\Textures\Uniforms\Police\Units\NCA_main.paa" };
			condition = "[player, [""Police""]] call ULP_fnc_isFaction && { [""Police_NCA"", 1] call ULP_fnc_hasAccess }";
		};
	};
};
...
class U_C_FormalSuit_01_tshirt_black_F {
	...
	class Textures {
		...
		class Ridge : U_C_FormalSuit_01_tshirt_gray_F {
			...
			textures[] = { "\dataM\Textures\Groups\Ridge\U_C_FormalSuit_01_tshirt_gray_F.paa" };
...
class U_I_ParadeUniform_01_AAF_decorated_F {
	...
	class Textures {
		class Command { 
			...
			textures[] = { 
				"\dataM\Textures\Uniforms\Police\parade_01.paa",
				"\dataM\Textures\Uniforms\Police\parade_02.paa",
				"\dataM\Textures\Uniforms\Police\parade_03.paa"
			};
			condition = "true";
		};
	};
...
class U_B_CombatUniform_mcam_worn {
	...
	class Textures {
		class RPU {
			displayName = "Traffic Uniform";
			textures[] = { "\dataM\Textures\Uniforms\Police\Units\RPU_main.paa" };
			condition = "[player, [""Police""]] call ULP_fnc_isFaction && { [""Police_RPU"", 1] call ULP_fnc_hasAccess }";
		};
	};
};
